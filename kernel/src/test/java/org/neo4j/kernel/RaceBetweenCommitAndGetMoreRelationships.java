...
public class RaceBetweenCommitAndGetMoreRelationships extends TimerTask
{
    private static final RelationshipType TYPE = DynamicRelationshipType.withName( "TYPE" );
    private static RaceBetweenCommitAndGetMoreRelationships instance;
    ...
    {
        RaceBetweenCommitAndGetMoreRelationships race = instance;
        if ( race != null ) try
        {
    ...
    private RaceBetweenCommitAndGetMoreRelationships( GraphDatabaseService graphdb, NodeManager nodeManager )
    {
